...
export const DEFAULT_SETTINGS = {
  ...
  "about/philosophy": {
    heading: "특수 분야의 깊이로\n결과를 만드는 로펌",
    description: "법무법인 하이로는 불법파견·게임사기·노동·군사건의 4개 분야만 집중적으로 다룹니다. 첫 상담부터 사건 종결까지, 해당 분야의 절차와 판례를 깊이 이해하는 변호사가 직접 사건을 진행합니다."
  },
  "about/greetings": {
  ...
  "about/history": {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "불법파견, 게임사기, 노동, 군사건 등 고유의 노하우가집적된 4대 특수 사법 분야의 독보적인 법률 권익 수호를 기치로 법무법인 하이로가 설립되어 법조계에 첫발을 내디뎠습니다."
      }
    ]
  },
  /* ── 구성원 ── */
