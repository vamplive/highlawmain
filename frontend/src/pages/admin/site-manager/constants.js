...
export const TABS = [
  ...
  { key: "about", label: "소개" },
  { key: "members", label: "구성원 편집" },
  { key: "practice", label: "업무분야" },
  { key: "news-edit", label: "소식" },
  { key: "recruit-edit", label: "채용" },
  { key: "consultation-edit", label: "상담/문의" },
...
export const DEFAULT_SETTINGS = {
  ...
  "about/philosophy": { heading: "Message from Partners", description: "법무법인 하이로는 Loyalty, Dignity, Integrity를 핵심 가치로 삼아, 클라이언트에게 최적의 법률 솔루션을 제공하기 위해 설립된 Premium Lawfirm Service 브랜드입니다.\n\n우리는 단순히 법률 지식을 전달하는 데 그치지 않습니다. 각 사안의 본질을 꿰뚫는 전문성을 바탕으로 문제의 이면을 파고들어 그 흐름과 구조를 분석함으로써, 보다 근본적이고 지속 가능한 해결책을 제시하고자 하고 있습니다.\n\n하이로의 구성원들은 모두 대형로펌에서 우수한 성과를 인정받은 전문가로서, 각자의 분야에서 풍부한 실무 경험과 학문적 깊이를 겸비하고 있습니다. 민사·형사소송은 물론 인사·노무, 국제법무, 기업법무, 부동산·건설, 지식재산권, 군사법 등 폭넓은 분야에서 탁월한 역량을 검증받았습니다.\n\n법무법인 하이로는 저희를 신뢰하는 클라이언트들이 언제든지 저희를 다시 찾아올 수 있는 믿음을 제공하고자 합니다. 한결같은 헌신과 지적인 품격, 그리고 변함없는 성실함으로 클라이언트의 신뢰를 지키고, 신뢰와 결과로 보답하는 법률 파트너가 되도록 하겠습니다.\n\n법무법인 하이로 대표변호사 조덕재 · 김범 · 강민구" },
  "about/values": { items: [{ title: "신의성실", subtitle: "LOYALTY", desc: "의뢰인의 신뢰를 가장 소중한 가치로 여기며, 어떠한 순간에도 의뢰인의 이익과 권리를 최우선으로 수호합니다." }, { title: "품격", subtitle: "DIGNITY", desc: "깊이 있는 학문적 성찰과 품위 있는 변론을 통해, 하이엔드 서비스에 걸맞은 차별화된 사법적 결과를 창출합니다." }, { title: "정직", subtitle: "INTEGRITY", desc: "사건의 실체를 투명하게 공유하고, 흔들림 없는 법조 윤리를 준수하며 타협하지 않는 정의를 지향합니다." }, { title: "전문성", subtitle: "EXPERTISE", desc: "대형 로펌 출신의 풍부한 실무 경험과 고도의 정밀 법리 분석으로 클라이언트에게 가장 정교한 솔루션을 제시합니다." }] },
  "about/history": { items: [
  ...
  "about/probono": { intro: "법무법인 하이로는 법치주의 확립과 사회 구성원 모두의 보편적 인권 옹호를 중요한 사명으로 여깁니다. 우리가 지닌 법률 전문성을 바탕으로 정의의 온기가 사회 곳곳에 미치도록 지속 가능한 사회공헌 활동을 실천합니다.", items: [
  ...
  "members/hero": { heading: "구성원", subheading: "PEOPLE", description: "각 분야 전문가들이 유기적으로 협력하여\n의뢰인에게 최선의 솔루션을 제공합니다" },
  "practice/hero": { heading: "업무분야", subheading: "PRACTICE AREAS", description: "검증된 실무 역량과 정교한 법리 해석을 결합하여,\n클라이언트의 가치를 실현하는 최적의 법률 솔루션을 제시합니다." },
  "practice/intro": { description: "법무법인 하이로는 다양한 법률 분야에서 축적된 경험과 전문성을 바탕으로 의뢰인에게 최적의 법률 솔루션을 제공합니다." },
  "practice/pain_points": { items: [
    { text: "복잡한 민사소송과 대여금·공사대금·손해배상 청구 문제로 앞날이 막막하다" },
    { text: "갑작스러운 형사 사건에 연루되어 경찰·검찰 수사와 구속 및 처벌 위험에 처해 있다" },
    { text: "부당해고, 임금체불 및 취업규칙·근로계약 등 인사 노무 관련 규정 정비가 시급하다" },
    { text: "경영권분쟁, 기업 경영 리스크, 주권 등 법적 리스크 관리 및 해결이 필요하다" },
    { text: "중대재해처벌법 및 산업안전보건법 준수를 위한 안전보건확보의무 구축이 어렵다" },
    { text: "스타트업 창업, 주주간 계약(SHA), 스톡옵션 등 성장 단계별 전문 자문이 필요하다" },
    { text: "이혼, 재산분할, 유산 상속 및 유류분 반환 소송 등으로 심각한 가족 간 갈등을 겪고 있다" },
    { text: "군 조직 내의 특수한 군형사사건 수사나 군인·군무원 보통징계위원회 징계에 직면했다" },
    { text: "국가, 지자체 또는 행정기관의 부당한 행정처분으로 불이익을 겪고 있다" },
  ...
  "practice/advantages": { items: [
    { title: "분야별 고도의 전문성", desc: "각 법률 영역에서 실무 담당자로 근무하였거나 대형로펌에서 오랜 경험과 노하우를 쌓은 전담 변호사가 사건을 맡아 정밀한 판례 분석과 법리 해석을 토대로 맞춤형 해법을 도출합니다." },
    { title: "현장과 절차의 정교한 이해", desc: "사실조사와 증거 수집부터 법원, 검찰, 노동위원회, 군사법원, 행정기관 등 각 기관별 특수한 절차적 메커니즘을 정확히 파악하여 빈틈없이 조력합니다." },
    { title: "신속하고 명확한 초기 대응", desc: "소송 및 분쟁 해결의 성패는 초기 대응에 달려 있습니다. 하이로는 상담 진행 후 신속하게 사건의 핵심 쟁점과 향후 대응 로드맵을 제공합니다." },
    { title: "일관성 있는 통합 해결", desc: "자문과 협상부터 소송 수행까지, 민·형사 및 행정 절차가 유기적으로 연계된 복잡한 사건도 전담 변호사가 처음부터 끝까지 일관된 맥락으로 책임지고 해결합니다." },
  ] },
  "practice/areas": { items: [
    { title: "민사 소송", url: "/practice/civil", subtitle: "CIVIL LITIGATION", desc: "손해배상, 계약 분쟁, 부동산, 채권추심 등 민사 전반에 걸친 소송 대리 및 자문 서비스를 제공합니다.", details: ["손해배상 청구", "계약 분쟁 해결", "부동산 관련 소송", "채권추심 및 강제집행"] },
    { title: "형사 변호", url: "/practice/criminal", subtitle: "CRIMINAL DEFENSE", desc: "수사 단계부터 재판까지 의뢰인의 권리를 보호하며, 최선의 변호를 제공합니다.", details: ["수사 단계 변호", "공판 변호", "피해자 대리", "범죄 피해 구제"] },
    { title: "가사 법률", url: "/practice/family", subtitle: "FAMILY LAW", desc: "이혼, 상속, 양육권 등 가사 분야에서 의뢰인의 권익을 세심하게 보호합니다.", details: ["이혼 소송 및 조정", "재산분할", "양육권·면접교섭", "상속·유언"] },
    { title: "기업 법무", url: "/practice/corporate", subtitle: "CORPORATE LAW", desc: "기업의 설립부터 운영, M&A까지 기업 활동 전반에 대한 법률 자문을 제공합니다.", details: ["기업 설립 및 구조조정", "M&A 자문", "계약서 검토 및 작성", "컴플라이언스"] },
    { title: "행정 소송", url: "/practice/administrative", subtitle: "ADMINISTRATIVE LAW", desc: "행정처분 취소, 인허가 쟁송, 국가배상 등 행정법 분야의 전문 법률 서비스를 제공합니다.", details: ["행정처분 취소소송", "인허가 관련 쟁송", "국가배상 청구", "공법상 당사자소송"] },
    { title: "조세 법률", url: "/practice/tax", subtitle: "TAX LAW", desc: "세무 조사 대응, 조세 불복, 세금 관련 분쟁 해결 등 조세 분야 법률 서비스를 제공합니다.", details: ["세무 조사 대응", "조세 불복 심판·소송", "세금 관련 분쟁", "절세 컨설팅"] },
    { title: "부동산", url: "/practice/real-estate", subtitle: "REAL ESTATE", desc: "부동산 거래, 임대차, 재개발·재건축 등 부동산 관련 법률 서비스를 제공합니다.", details: ["매매·임대차 분쟁", "재개발·재건축", "등기 관련 소송", "건축 분쟁"] },
    { title: "계약서 작성·검토", url: "/practice/contract", subtitle: "CONTRACT REVIEW", desc: "각종 계약서의 작성, 검토, 수정을 통해 법적 리스크를 사전에 차단합니다.", details: ["계약서 작성·검토", "약관 검토", "MOU 작성", "국제 계약"] },
    { title: "내용증명", url: "/practice/certified-mail", subtitle: "CERTIFIED MAIL", desc: "채권 추심, 계약 해지 등 법적 효력이 있는 내용증명 작성 및 발송을 대행합니다.", details: ["채권 추심 내용증명", "계약 해지 통보", "권리 주장 서면", "답변서 작성"] },
    { title: "합의 대행", url: "/practice/settlement", subtitle: "SETTLEMENT NEGOTIATION", desc: "소송 전 합의 및 협상을 통해 의뢰인에게 최적의 결과를 도출합니다.", details: ["소송 전 합의 대행", "손해배상 협상", "분쟁 조정", "화해 절차"] },
    { title: "종합 법률상담", url: "/practice/consultation", subtitle: "GENERAL CONSULTATION", desc: "다양한 법률 문제에 대한 종합적인 상담 및 자문 서비스를 제공합니다.", details: ["초기 법률 상담", "법률 의견서 작성", "리스크 진단", "분쟁 예방 자문"] },
  ] },
  ...
  "layout/contact": { phone: "02-6925-6757", kakaoUrl: "https://pf.kakao.com/_highlawofficial/chat", telegramUrl: "https://t.me/YounSeHwan", instagramUrl: "https://www.instagram.com/highlaw.official?igsh=ZGg2N3hmaDNkZjJw", naverBlogUrl: "https://blog.naver.com/highlaw", youtubeUrl: "https://www.youtube.com/@%ED%95%98%EC%9D%B4%EB%A1%9C%EC%8A%A4%ED%8A%9C%EB%94%94%EC%98%A4", telegramEnabled: true, kakaoEnabled: true, phoneEnabled: true, instagramEnabled: true, naverBlogEnabled: true, youtubeEnabled: true, naverReservationEnabled: false, naverReservationUrl: "" },
  "news/hero": { heading: "하이로 소식", subheading: "BLOG & NEWS", description: "전문 변호사들이 직접 분석한 최신 판례 분석과 특화 분야 법률 정보를 제공합니다." },
  "recruit/hero": { heading: "인재 채용", subheading: "CAREERS AT HIGHLAW", description: "신의성실(Loyalty)과 품격(Dignity)을 바탕으로, 탁월한 법률 솔루션을 창출해 나갈 하이로의 인재를 모십니다." },
  "recruit/guide": { content: "법무법인 하이로 채용에 관심 가져주셔서 감사합니다.\n\n지원 방법: 채용 공고 확인 후 이메일 또는 채용 문의 채널로 서류를 제출해 주세요.\n\n전형 절차: 서류 전형 → 1차 면접 → 최종 합격\n\n제출 서류: 이력서, 자기소개서, 포트폴리오(해당자)\n\n문의: 채용 관련 문의는 채용 담당자에게 연락해 주세요." },
  "recruit/contact": {
    email: "",
    phone: "",
    hours: "평일 09:00 - 18:00",
    note: "이력서와 자기소개서를 이메일로 보내주세요.",
  },
    "consultation/contact": {
    address: "서울특별시 강남구 테헤란로 141, 15층",
    phone: "02-6925-6757",
    email: "",
    hours: "평일 09:00 - 18:00 (예약 상담 우선)",
    businessNumber: "433-86-04078",
  },
    "consultation/hero": { heading: "상담안내", subheading: "CONSULTATION", description: "법무법인 하이로의 1:1 맞춤 법률 상담을 신청하세요. 전문 변호사가 직접 상담합니다." },
  "consultation/process": { items: [
