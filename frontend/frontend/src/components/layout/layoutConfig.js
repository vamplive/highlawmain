...
export const LAYOUT_DEFAULTS = {
  nav: { items: [{ to: "/about", label: "The Firm" }, { to: "/lawyers", label: "Partners" }, { to: "/practice", label: "Practices" }, { to: "/blog", label: "News" }, { to: "/recruit", label: "Recruit" }, { to: "/inquiry", label: "Inquiry" }] },
